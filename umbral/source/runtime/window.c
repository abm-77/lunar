...
int32_t rt_get_key_down(um_window_handle_t h, um_key_t k) {
  ...
  if (!e) return 0;
#if UM_DEBUG
  if (!key_valid(k)) { trap_bad_key("rt_get_key_down", k); return 0; }
#endif
...
int32_t rt_get_key_up(um_window_handle_t h, um_key_t k) {
  ...
  if (!e) return 0;
#if UM_DEBUG
  if (!key_valid(k)) { trap_bad_key("rt_get_key_up", k); return 0; }
#endif
  return !kb_bitset_test(e->input.keys, (uint32_t)k);
}
...
int32_t rt_get_key_pressed(um_window_handle_t h, um_key_t k) {
  ...
  if (!e) return 0;
#if UM_DEBUG
  if (!key_valid(k)) { trap_bad_key("rt_get_key_pressed", k); return 0; }
#endif
  return kb_bitset_test(e->input.keys, (uint32_t)k) &&
...
int32_t rt_get_key_released(um_window_handle_t h, um_key_t k) {
  ...
  if (!e) return 0;
#if UM_DEBUG
  if (!key_valid(k)) { trap_bad_key("rt_get_key_released", k); return 0; }
#endif
  return !kb_bitset_test(e->input.keys, (uint32_t)k) &&
         kb_bitset_test(e->input.prev_keys, (uint32_t)k);
}
...
int32_t rt_get_mouse_button_down(um_window_handle_t h, um_mouse_button_t b) {
  ...
  if (!e) return 0;
#if UM_DEBUG
  if (!mouse_button_valid(b)) { trap_bad_mouse_button("rt_get_mouse_button_down", b); return 0; }
#endif
...
int32_t rt_get_mouse_button_up(um_window_handle_t h, um_mouse_button_t b) {
  ...
  if (!e) return 0;
#if UM_DEBUG
  if (!mouse_button_valid(b)) { trap_bad_mouse_button("rt_get_mouse_button_up", b); return 0; }
#endif
  return !mb_bitset_test(e->input.mouse_buttons, b);
}
...
int32_t rt_get_mouse_button_pressed(um_window_handle_t h, um_mouse_button_t b) {
  ...
  if (!e) return 0;
#if UM_DEBUG
  if (!mouse_button_valid(b)) { trap_bad_mouse_button("rt_get_mouse_button_pressed", b); return 0; }
#endif
  return mb_bitset_test(e->input.mouse_buttons, b) &&
...
int32_t rt_get_mouse_button_released(um_window_handle_t h, um_mouse_button_t b) {
  ...
  if (!e) return 0;
#if UM_DEBUG
  if (!mouse_button_valid(b)) { trap_bad_mouse_button("rt_get_mouse_button_released", b); return 0; }
#endif
  return !mb_bitset_test(e->input.mouse_buttons, b) &&
         mb_bitset_test(e->input.prev_mouse_buttons, b);
}
